...
function CommandInput({
  ...
  return (
    <div
      ...
      className="m-1 mb-0 flex h-9 items-center gap-2 rounded-2xl bg-input/50 px-3"
    >
      <SearchIcon aria-hidden="true" className="size-4 shrink-0 opacity-50" />
      <CommandPrimitive.Input
        data-slot="command-input"
        className={cn(
          "h-full min-w-0 flex-1 bg-transparent text-sm outline-hidden disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
